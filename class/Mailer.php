...
class Mailer
{
    ...
    public function sendNotificationAndAttachment($recipientName, $recipientEmail, $attachPath, $message)
    {
        try {
            $mail = new PHPMailer(true);
            ...
            $mail->isHTML(true);
            $mail->Subject = 'Envío de PDF';
            $mail->Body = '¡Hola ' . $recipientName . '! Adjunto encontrarás el archivo PDF solicitado, ' . $message;
